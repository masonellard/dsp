...
Frequentist and Bayesian statistics differ primarily in the way that they define probability. According to frequentists, probability is the long-term rate of occurrence of repeatable random events. Frequentists don't attach probability to unknown values. In Bayesian statistics, you can use probability to represent uncertainty with unknown values.
